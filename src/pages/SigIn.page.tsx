              ...
              <div className={'rounded-xl bg-white dark:bg-gray-800 shadow-xl'} id={'default-modal'}>
                ...
                <div className={'p-8'}>
                  ...
                  <div className={'mt-10 grid space-y-4'}>
                    ...
                    {/* Github Icon */}
                    <button onClick={() => navigateTo('github')} className={'group h-12 px-6 border-2 border-gray-300 rounded-full transition duration-300 hover:border-blue-400 focus:bg-blue-50 active:bg-blue-100'}>
                      <div className={'relative flex items-center space-x-4 justify-center'}>
