          ...
          <div className={'relative container m-auto px-6'}>
            <div className={'m-auto md:w-7/12'}>
              <div className={'rounded-xl bg-white dark:bg-gray-800 shadow-xl'} id={'default-modal'}>
                <button onClick={() => closeModal()} className={'float-end text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white'}>
                ...
                <div className={'p-8'}>
                  ...
                  <div className={'mt-10 grid space-y-4'}>
                    ...
                    <button className="group h-12 px-6 border-2 border-gray-300 rounded-full transition duration-300 hover:border-blue-600 focus:bg-blue-50 active:bg-blue-100">
                      <div className="relative flex items-center space-x-4 justify-center">
                        {/* Icono de Microsoft: cuatro rectángulos coloreados */}
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" className="absolute left-0 w-5 h-5">
                          <rect x="1" y="1" width="6" height="6" fill="#F25022" /> {/* Rojo anaranjado :contentReference[oaicite:4]{index=4} */}
                          <rect x="9" y="1" width="6" height="6" fill="#7FBA00" /> {/* Verde :contentReference[oaicite:5]{index=5} */}
                          <rect x="9" y="9" width="6" height="6" fill="#00A4EF" /> {/* Azul claro :contentReference[oaicite:6]{index=6} */}
                          <rect x="1" y="9" width="6" height="6" fill="#FFB900" /> {/* Amarillo :contentReference[oaicite:7]{index=7} */}
                        </svg>
