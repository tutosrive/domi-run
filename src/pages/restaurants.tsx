...
import ProductService from '../services/testproducts';
...
export default class DataTableCrudDemo extends Component {
  ...
  ratingBodyTemplate(rowData) {
    return <Rating value={rowData.rating} readOnly={true} cancel={false} />;
  }
        ...
        <Dialog visible={this.state.productDialog} style={{ width: '450px' }} header="Product Details" modal className="p-fluid" footer={productDialogFooter} onHide={this.hideDialog}>
          ...
          <div className="p-formgrid p-grid">
            ...
            <div className="p-field p-col">
              ...
              <InputNumber id="quantity" value={this.state.product.quantity} onValueChange={(e) => this.onInputNumberChange(e, 'quantity')} integeronly={'true'} />
            </div>
          </div>
        </Dialog>
